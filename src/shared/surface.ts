...
export const SURFACE: Surface = {
  ...
  planSplit: ['invoke', 'sessions:planSplit'],
  startDrive: ['invoke', 'drive:start'],
  stopDrive: ['invoke', 'drive:stop'],
  stopAllDrives: ['invoke', 'drive:stopAll'],
  listDrives: ['invoke', 'drive:list'],
  clearDrives: ['invoke', 'drive:clear'],
  addGoal: ['invoke', 'goal:add'],
  listGoals: ['invoke', 'goal:list'],
  cancelGoal: ['invoke', 'goal:cancel'],
  retryGoal: ['invoke', 'goal:retry'],
  removeGoal: ['invoke', 'goal:remove'],
  clearGoals: ['invoke', 'goal:clear'],
  startSplit: ['invoke', 'sessions:split'],
  ...
  improvePrompt: ['invoke', 'improve:run'],
  answerImprove: ['invoke', 'improve:answer'],
  cancelImprove: ['send', 'improve:cancel'],
  researchRequest: ['invoke', 'research:run'],
  cancelResearch: ['send', 'research:cancel'],
  applyImproved: ['invoke', 'improve:apply'],
  recordImprove: ['send', 'improve:record'],
  ...
  onDrive: ['on', 'drive:changed'],
  onGoals: ['on', 'goals:changed'],
