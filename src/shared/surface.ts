...
export const SURFACE: Surface = {
  ...
  continueFresh: ['invoke', 'sessions:continueFresh'],
  continuationStatus: ['invoke', 'sessions:continuationStatus'],
  ...
  replaceDraft: ['send', 'pty:replaceDraft'],
  ...
  checkSetup: ['invoke', 'setup:check'],
  installGit: ['invoke', 'setup:installGit'],
  ...
  openScreen: ['invoke', 'screen:open'],
  screenTakeControl: ['send', 'screen:control'],
  screenSignal: ['invoke', 'screen:signal'],
  screenWake: ['invoke', 'screen:wake'],
  onScreenSignal: ['on', 'screen:signal'],
  ...
  expandPrompt: ['invoke', 'prompt:expand'],
  expandChose: ['send', 'prompt:expandChose'],
  ...
  installTailscale: ['invoke', 'remote:installTailscale'],
  onData: ['on', 'pty:data'],
