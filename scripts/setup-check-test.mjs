...
is(
  setupRows({ platform: 'darwin', claudeInstalled: false, gitInstalled: false, signedIn: false }).map((r) => r.id),
  ['claude', 'signin'],
...
is(
  setupRows({ platform: 'darwin', claudeInstalled: true, gitInstalled: false, signedIn: false }).map((r) => r.id),
  ['signin'],
...
is(
  setupRows({ platform: 'darwin', claudeInstalled: true, gitInstalled: true, signedIn: true }),
  [],
  'all good -> no rows'
)
...
is(
  setupRows({ platform: 'linux', claudeInstalled: true, gitInstalled: true, signedIn: true }),
  [],
...
is(
  setupRows({ platform: 'win32', claudeInstalled: false, gitInstalled: false, signedIn: false }).map((r) => r.id),
  ['git', 'claude', 'signin'],
...
is(
  setupRows({ platform: 'win32', claudeInstalled: false, gitInstalled: true, signedIn: false }).map((r) => r.id),
  ['claude', 'signin'],
...
is(
  setupRows({ platform: 'win32', claudeInstalled: true, gitInstalled: false, signedIn: true }).map((r) => r.id),
  ['git'],
...
ok(
  !setupRows({ platform: 'darwin', claudeInstalled: true, gitInstalled: false, signedIn: true }).some((r) => r.id === 'git'),
